module.exports = (Discord, client, message) => {
    ...
    if (!message.content.startsWith(prefix)) {
        ...
        if (strMsg.includes("SAINDO") || strMsg.includes("PARTIU") || strMsg.includes("ATÉ AMANHÃ") || strMsg.includes("ATÉ AMANHA") || strMsg.includes("ATE AMANHA") || strMsg.includes("ATE AMANHÃ")) {
